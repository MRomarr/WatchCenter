...
namespace WatchCenter.API.Controllers
{
    ...
    public class contentsController : ControllerBase
    {
        ...
        public contentsController(IContentService contentService, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> CreateAsync([FromBody] CreateContentDto dto)
        {
